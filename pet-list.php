...
$total_pets_sql = "SELECT COUNT(*) as total FROM pet WHERE adoptionStatus='0'";
...
$sql = "SELECT * FROM pet WHERE adoptionStatus='0' LIMIT $limit OFFSET $offset";
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            <ul>
                <li style="background-color: #5291f7; border-radius: 20px;" class="glow-button"><a href="pet-list.php"><p>All</p></a></li>
